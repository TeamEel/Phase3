...
public class OperatorSoftwareTest {
	...
	@Test(expected = InvalidComponentException.class)
	public void testFixInvalidComponent() throws InvalidComponentException, FixAlreadyUnderwayException, NoFixNeededException {
		op.fix(Component.WATERPUMP);
	}

	@Test(expected = InvalidPumpException.class)
	public void testFixInvalidWaterPump() throws NumberFormatException, InvalidComponentException, FixAlreadyUnderwayException, NoFixNeededException, InvalidPumpException {
