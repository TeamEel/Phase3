...
/**
 * MajorComponent abstract class, used for components that can carry water/steam
 * and have pressure and temperature
 * 
 * @author Team Haddock
 * 
 */
public abstract class MajorComponent extends Component implements Serializable {
	 ...
	 * 
	 * @param steamLevel
	 *            The level of steam stored in the MajorComponent
	 * @param temperature
	 ...
	 */
	public MajorComponent(int steamLevel, double temperature, double pressure, double waterLevel, double failProb, int fixTime) {
	 ...
	 */
	public MajorComponent(int steamLevel, double temperature, double pressure, double waterLevel, double radius, double waterSurfaceArea, int height, double failProb, int fix, boolean functioning, boolean repairal, int fixingProgress) {
	...
	public void calculatePressure() {
		...
		if (pressure > 6000) pressure = 6000;
	 ...
	 *         if the MajorComponent contains less than the amount specified.
	 */
	 ...
	 * 
	 * @param amount
	 *            The amount of steam to be added in cm.
	 * @param temperature
	 *            of the team being added
	 */
	 ...
	 * 
	 * @param amount
	 *            The amount of steam to be drained in cm.
	 * @return The amount drained, this is different from the specified amount
	 *         if the
