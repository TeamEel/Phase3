...
/**
 * The nuclear reactor, evaporates water to steam as part of the boiling water
 * reactor model.
 * 
 * @author Team Haddock
 * 
...
public class Reactor extends MajorComponent implements Serializable {
	 ...
	 * 
	 * @param rodHeight
	 *            is the height the rods are at, out of 100
	 * @param activity
	 *            is the level of activity in the reactor
	 * @param steamLevel
	 ...
	 */
	public Reactor(int rodHeight, int activity, int steamLevel, double temperature, double pressure, double waterLevel, double radius, double waterSurfaceArea, int height, double failProb, int fix, boolean functioning, boolean repairal,
			int fixingProgress) {
	 ...
	 * 
	 * @param amount
	 *            The amount to reduce the height by, as a value between 0 and
	 *            100
	 * @throws InvalidRodsException
	 *             Thrown when amount specified is either negative or would
	 *             force rods outside logical region
	 * @throws MinimumRodsException
	 *             Thrown when the height of the rods attempts to exceed the
	 *             minimum
	 ...
	 * 
	 * @param amount
	 *            The amount to increase the height by, as a value between 0 and
	 *            100
	 * @throws InvalidRodsException
	 *             Thrown when amount specified is either negative or would
	 *             force rods outside logical region
	 ...
	 *             Thrown when the height of the rods attempts to exceed the
	 *             maximum
	 * @throws ComponetFailedException
	 *             Thrown if method is called when component is failed.
	 */
	...
	/**
	 * 
	 * @return The height of the reactor control rods as a value between 0
	 *         (fully down) and 100 (fully up)
	 */
	 ...
	 * 
	 * @param amount
	 *            The amount of water to be drained in cm.
	 * @return The amount drained, this is different from the specified amount
	 *         if the
