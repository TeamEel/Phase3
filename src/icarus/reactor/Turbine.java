...
/**
 * A turbine that converts steam passed over it to rotation, used in conjunction
 * with a generator
 * 
 * @author Team Haddock
 * 
...
public class Turbine extends Component implements Serializable {
	...
	/**
	 * Calculates the new RPM of the turbine dependent on a volume of steam
	 * passed over it
	 * 
	 * @param steamAmount
	 *            The amount of steam passing over the turbine
	 */
