...
public class CommandFactory {
    ...
    /**
     * The next() method just calls next in OperatorSoftware (calculations are done here)
     */
    public void next() {
        op.next();
    }
     ...
     * @throws NoFixNeededException
     */
    public void fix(Component component, int pumpNum) throws InvalidPumpException, InvalidComponentException,
